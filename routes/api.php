...
Route::group(['prefix' => 'auth'], function ($router) {
    ...
    Route::post('logout', [\App\Http\Controllers\AuthController::class, 'logout'])->middleware('jwt');
    Route::get('me', [\App\Http\Controllers\AuthController::class, 'getProfile'])->middleware('jwt');
});
